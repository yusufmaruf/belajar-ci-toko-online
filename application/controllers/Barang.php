...
class Barang extends CI_Controller {
	...
	public function add()
	{
		$this->form_validation->set_rules('nama_barang', 'nama_barang', 'required',(['required' => '%s harus diisi']));
		$this->form_validation->set_rules('id_kategori', 'id_kategori', 'required',(['required' => '%s harus diisi']));
		$this->form_validation->set_rules('harga', 'harga', 'required',(['required' => '%s harus diisi']));
		$this->form_validation->set_rules('deskripsi', 'deskripsi', 'required',(['required' => '%s harus diisi']));
